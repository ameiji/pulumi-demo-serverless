...
import pulumi_logo from './pulumi.png';
        ...
        <Jumbotron>
          <Row>
            <Col md="6" className="logo">
              ...
              <p>This is a demo that showcases AWS serverless provisioned with Pulumi.</p>
              <p>The application is built using Pulumi, and uses AWS Lambda, Amazon DynamoDB, and Amazon API Gateway for API services and Amazon Cognito for identity.</p>

              <img src={logo} alt="Logo" />
              <img src={pulumi_logo} alt="Pulumi" />
            </Col>
            <Col md="6">
              {idToken.length > 0 ?
                (
